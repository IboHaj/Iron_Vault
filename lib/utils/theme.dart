...
class MaterialTheme {
  final textTheme = TextTheme(
    ...
    displaySmall: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold),
    ...
    headlineSmall: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700),
    titleLarge: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold),
    titleMedium: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w400),
    titleSmall: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w400),
    bodyLarge: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w300),
    bodyMedium: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
    bodySmall: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w300),
    labelLarge: TextStyle(color: Colors.blue, fontSize: 24, fontWeight: FontWeight.w600),
    labelMedium: TextStyle(color: Colors.grey, fontSize: 20, fontWeight: FontWeight.w600),
    labelSmall: TextStyle(color: Colors.grey, fontSize: 16, fontWeight: FontWeight.w600),
  );
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff126045),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffa2ecc7),
      surfaceTint: Color(0xff8dd5b2),
      onPrimary: Color(0xff002c1d),
      primaryContainer: Color(0xff579e7e),

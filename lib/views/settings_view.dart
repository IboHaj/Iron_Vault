...
import 'package:iron_vault/notifiers/locale_notifier.dart';
...
class SettingsView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ValueNotifier<String> locale = ValueNotifier(ref.watch(localeProvider).languageCode);
                            ...
                            Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  onChanged: (value) {
                                    if (value?.substring(0, 2).toLowerCase() != locale.value) {
                                      if (value == "Arabic") {
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomButton(
                        ...
                        onTap: () async {
                         await CustomDialog.showExportInfoDialog(
                            context,
                            ref.read(allCredentialsProvider.notifier).exportAll,
                          );
                        },
